				...
				CKEDITOR.dialog.add('sourcedialog', function (editor) {
					...
					return {
						...
						onShow: function () {
							...
							//Aggiunta MB
							if (!IsStyleSheetAlreadyLoaded(rootPath + 'css/show-hint.css')) {
								CKEDITOR.document.appendStyleSheet(rootPath + 'css/show-hint.css');
							}
							//Fine aggiunta
				...
				case "htmlmixed":
					{
						...
						//Aggiunta MB
						scriptFiles.push(rootPath + 'js/codemirror.hint.min.js');
