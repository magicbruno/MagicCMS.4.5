...
CKEDITOR.addTemplates("default",
	{
		imagesPath: "/Themes/Winstrap/ckeditor/plugins/templates/images/",
		templates: [
			{
				title: "Bootstrap two columns",
				image: "template_2cols.png",
				description: "Two equal columns.",
				html: '<div class="row"><div class="col-sm-12">Insert content</div><div class="col-sm-12">Insert content</div></div>'
			},
			{
				title: "Bootstrap two columns 8-16",
				image: "template_2cols_sideBar_left.png",
				description: "One large column with left sidebar.",
				html: '<div class="row"><div class="col-sm-8">Insert content</div><div class="col-sm-16">Insert content</div></div>'
			},
			{
				title: "Bootstrap two columns 16-8",
				image: "template_2cols_sideBar_right.png",
				description: "One large column with right sidebar..",
				html: '<div class="row"><div class="col-sm-16">Insert content</div><div class="col-sm-8">Insert content</div></div>'
			},
			{
				title: "Bootstrap three columns",
				image: "template_3cols.png",
				description: "Three equal columns.",
				html: '<div class="row"><div class="col-sm-8">Insert content</div><div class="col-sm-8">Insert content</div><div class="col-sm-8">Insert content</div></div>'
			},
			{
			...
			},
			{
				...
				html: '<div class="row"><div class="col-sm-6">Insert content</div><div class="col-sm-6">Insert content</div><div class="col-sm-6">Insert content</div><div class="col-sm-6">Insert content</div></div>'
			}]
	});
